...
public class CityInfoController {
	...
	private class AddCityListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			model.addToCitList(new City(inputView.jtfName.getText(), inputView.jtfState.getText(), inputView.jtfPopulation.getText(), inputView.jcbYear.getSelectedItem().toString()));
			System.out.println(inputView.jtfName.toString());
		}
